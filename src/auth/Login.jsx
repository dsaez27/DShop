...
const Container = styled.div`
	width: min(100%, 100vw);
	height: 100vh;
	background: linear-gradient(rgba(255, 255, 255, 0.2), rgba(27, 27, 27, 0.3)),
		url('https://res.cloudinary.com/djv0cypxw/image/upload/v1657850487/Store/background/bg-01.jpg') center no-repeat;
